const module_key = 'quizByCategory';
...
export const GET_QUIZ_COURSES = `${module_key}_get_quiz_courses`;
export const GOT_QUIZ_COURSES = `${module_key}_got_quiz_courses`;
export const UPDATE_SUBJECT = `${module_key}_update_subject`;
export const UPDATE_STANDARD = `${module_key}_update_standard`;
export const ERROR_GETTING_QUIZ_COURSES = `${module_key}_error_getting_quiz_courses`;
...
export const getQuizCourses = (data) => ({
  type: GET_QUIZ_COURSES,
  payload: data,
});

export const gotQuizCourses = (data) => ({
  type: GOT_QUIZ_COURSES,
  payload: data,
});

export const errorGettingQuizCourses = (data) => ({
  type: ERROR_GETTING_QUIZ_COURSES,
  payload: data,
});
